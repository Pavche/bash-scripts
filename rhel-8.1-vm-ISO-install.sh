...
URL="http://$SERVER/rel-eng/latest-RHEL-8.1/compose/BaseOS/x86_64/"
REPO_URL=$URL"os/"
...
printf "$FORMAT" "BaseOS Repo" $REPO_URL
printf "$FORMAT" "AppStream Repo" $REPO2_URL
echo ${line// /-}
...
#  \
# --initrd-inject /home/pgeorgie/VM/kickstart/rhel-8.1/kickstart.cfg \
